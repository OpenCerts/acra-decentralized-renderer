...
describe("company", () => {
  ...
  describe("audits", () => {
    ...
    it("should display audit header if there is audit", () => {
      const { queryByText } = render(<CompanyProfile document={{ ...companyProfile }} handleObfuscation={() => 0} />);
      // eslint-disable-next-line jest/no-truthy-falsy
  ...
  describe("representatives", () => {
    ...
    it("should display dq next to name when representative is dq", () => {
      const { getAllByTestId } = render(
        <CompanyProfile document={{ ...companyProfile }} handleObfuscation={() => 0} />
      );
  ...
  describe("shareholders", () => {
    ...
    it("should display shareholder header if there is shareholders and no shareholders groups", () => {
      const { queryByText } = render(
        <CompanyProfile document={{ ...companyProfile, shareholderGroups: [] }} handleObfuscation={() => 0} />
      );
      // eslint-disable-next-line jest/no-truthy-falsy
  ...
  describe("registration condition", () => {
    it("should hide registration condition header if there is no registration condition", () => {
      const { queryByText } = render(
        <CompanyProfile
          document={{ ...companyProfile, registrationCondition: undefined }}
          handleObfuscation={() => 0}
        />
      );
  ...
  describe("shares", () => {
    it("should hide shares header if there is no shares", () => {
      const { queryByText } = render(
        <CompanyProfile document={{ ...companyProfile, shares: [] }} handleObfuscation={() => 0} />
      );
  ...
  describe("judicial managers", () => {
    it("should hide judicial managers header if there is no judicial managers", () => {
      const { queryByText } = render(
        <CompanyProfile document={{ ...companyProfile, judicialManagers: [] }} handleObfuscation={() => 0} />
      );
  ...
  describe("liquidators", () => {
    it("should hide liquidators header if there is no liquidators", () => {
      const { queryByText } = render(
        <CompanyProfile document={{ ...companyProfile, liquidators: [] }} handleObfuscation={() => 0} />
      );
  ...
  describe("provisional liquidators", () => {
    it("should hide provisional liquidators header if there is no provisional liquidators", () => {
      const { queryByText } = render(
        <CompanyProfile document={{ ...companyProfile, provisionalLiquidators: [] }} handleObfuscation={() => 0} />
      );
  ...
  describe("receivers", () => {
    it("should hide receivers header if there is no receivers", () => {
      const { queryByText } = render(
        <CompanyProfile document={{ ...companyProfile, receivers: [] }} handleObfuscation={() => 0} />
      );
